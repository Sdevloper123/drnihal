...
<?php foreach ($service_banner_sliders as $service_banner_item): ?>
    ...
    <div class="home_banner_section inner-banner"
        style="background-image: url('<?php echo $service_banner_item['banner_images']['url']; ?>">
        <div class="wrapper">
            <div class="banner_content">
                <h1>
                    <?php echo $service_banner_item['banner_heading']; ?>
                </h1>
                <div class="specialist">
                    <?php echo $service_banner_item['banner_sub_heading']; ?>
                </div>
                ...
                <div class="innovation_hafeez-left">
                    ...
                    <div class="innovation_hafeez-left_deta common-conetnt">
                        ...
                        <div class="btn_inovation">
                            <a href="<?php echo get_permalink($post->ID); ?>"> Know More </a>
                            <a href="#!"> Download </a>
                        </div>
                    </div>
                </div>
                            ...
                            <a href="javascript:void(0)" tabindex="0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="94.462" height="94.462"
                                    ...
                                    <path id="Icon_material-play-circle-outline" data-name="Icon material-play-circle-outline"
                                        ...
                                        transform="translate(-1.5 -1.5)" fill="none" stroke="--theme-white-color:"
                                        stroke-width="3"></path>
                                </svg>
                            </a>
                        </div>
...
<?php
// $parent_blog_cat = 3;
// $sub_cat = array('taxonomy' => 'news-category', 'hide_empty' => false, 'parent' => $parent_blog_cat, 'exclude' => 1);
$blog_child_cats = get_terms('news-category');
?>
...
<section class="innovation_news">
    <div class="wrapper">
        ...
        <div class="blog-load-list">
            <div class="innovation_bottom innovation_slider">
                <?php
                            ...
                            <div class="innovation_news_deta">
                                ...
                                <div class="innovation_news_deta_iner common-conetnt">
                                    <h2>
                                        ...
                                        echo mb_strimwidth(strip_tags(get_the_title($post->ID)), 0, 60, '...'); ?>
