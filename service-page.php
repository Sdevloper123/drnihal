...
$clinical_expertise_heading = get_field('clinical_expertise_heading');
        ...
        <div class="clinical-expertise-inner">
            <div class="clinical-expertise-title">
                <h2 class="common-heading">
                    <?php echo $clinical_expertise_heading; ?>
                </h2>
            </div>
            <div class="clinical-expertise-left">
                <?php $clinical_count = 1;

                foreach ($clinical_expertise_lists as $clinical_expertise) {
                    $clinical_expertise_id = $clinical_expertise->ID;
                    $clinical_expertise_images = get_field('clincal_images', $clinical_expertise_id);
                    ?>
                    ...
                    <div class="clinicallist <?php echo ($clinical_count > 1) ? 'hide' : ''; ?> "
                        ...
                        <div class="urogynaecology_sec">
                            <div class="urogynaecology_img">
                                <img src="<?php echo $clinical_expertise_images ?>" alt="">
                            ...
                            <div class="urogynaecology_deta common-conetnt">
                                <h3>
                                    <?php $title = get_the_title($clinical_expertise_id);
                                    echo mb_strimwidth(strip_tags($title), 0, 120, '...')
                                        ?>
                                </h3>
                                <div>
                                    <?php // $content2 = get_post_field('post_content', $clinical_expertise_id);
                                            // echo get_the_content($clinical_expertise_id);
                                    
                                            echo wpautop($clinical_expertise->post_content);
                                            // echo mb_strimwidth(strip_tags($content2), 0, 400, '...')
                                    
                                            ?>
                                </div>

                                <a href="<?php echo get_permalink($clinical_expertise_id); ?>"
                                    class="theme-btn-primary-outline"> KNOW MORE </a>
                            </div>
                        </div>
                    </div>
                    <?php $clinical_count++;
                            ...
                            <div class="cover">
                                ...
                                <div class="thumb" id="thumb-content">
                                    <p class="common-conetnt">
                                        ...
                                        echo mb_strimwidth(strip_tags($content), 0, 310, '...')
                                            ?>
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="testimonials-box">
                            ...
                            <div class="testimonials-content common-conetnt">
                                <p>
                                    <?php $content3 = get_post_field('post_content', $testimonial_id);
                                    echo mb_strimwidth(strip_tags($content3), 0, 325, '...');
                                    ?>
                                </p>
                            </div>
                        </div>
