...
$professional_know_more_link = get_field('professional_know_more_link');
$professional_description = get_field('professional_description');
$professional_tab_image = get_field('professional_tab_image');

$assignment_heading = get_field('assignment_main_heading');
$assignment_view_more_text = get_field('assignment_view_more_text');
$assignment_view_more_link = get_field('assignment_view_more_link');
$assignment_know_more_text = get_field('assignment_know_more_text');
$assignment_know_more_link1 = get_field('assignment_know_more_link');
$assignment_description = get_field('assignment_description');
$assignment_image = get_field('assignment_image');
...
<section class="about_section">
  <div class="about_wrapper">
    <div class="about_img_wrapper">
      ...
      <img src="<?php echo $about_image; ?>" alt="Dr. Hafeez">
    </div>
      ...
      <div class="tab-menu professional-left">
        <ul>
          <li><a href="#" class="active" data-rel="tab-1">
              <div class="tab-img"><img src="<?php echo $professional_tab_image ?>">
              </div>
              <div class="tab-list">
          ...
          <li><a href="#" data-rel="tab-2" class="">
              <div class="tab-img">
                <img src="<?php echo $assignment_image ?>">
              </div>
              <div class="tab-list">
      ...
      <div class="tab-main-box professional-right">
        <div class="tab-box" id="tab-1" style="display:block;">
          ...
          <div class="tab-btn">
            ...
            <a class="theme-btn-primary" href="<?php echo $professional_know_more_link; ?>">
        ...
        <div class="tab-box" id="tab-2">
          ...
          <div class="tab-btn">
            ...
            <a class="theme-btn-primary" href="<?php echo $assignment_know_more_link1; ?>">
      ...
      <div class="sunrise-row">
        ...
        <div class="sunrise-right">
          <div class="common-conetnt sunrise-right-content">
            <p>
              <?php
              echo mb_strimwidth(strip_tags($hospitals_description), 0, 573, '...'); ?>
            </p>
  ...
  <div class="wrapper">
    <div class="clinical-row">
      ...
      <?php foreach ($clinical_expertise_list as $clinical_item_id):
        $icon_image = get_field('clinic_icon', $clinical_item_id);
        ...
        <div class="clinical-box">
          <div class="clinical-img">
            ...
            <div class="clinical-img-conten">
              ...
              <p>
                <?php $content4 = get_post_field('post_content', $clinical_item_id);
                echo mb_strimwidth(strip_tags($content4), 0, 70, '...');
                ?>
              </p>
      ...
      <div class="clinical-bottom">
        ...
        <div class="clinical-btn">
          <a class="theme-btn-primary" href="<?php echo $book_appointment_link; ?>">
      ...
      <div class="innovations-left">
        <div class="tab-box-top">
          <ol>
            ...
            <li><a href="<?php echo get_site_url() ?>/innovation">View More</a></li>
          </ol>
        </div>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <?php foreach ($informationLists as $informationList_id):
            ...
            <li class="nav-item" role="presentation">
                ...
                <div class="innovations-box">
                  ...
                  <div class="innovations-content ">
                    ...
                    <p class="clinical-content">
                      ...
                      echo trim(strlen(strip_tags($content)) > 100 ? substr(strip_tags($content), 0, 90) . "...." : strip_tags($content)); ?>
              ...
              <!-- <button class="theme-btn-primary" onclick="">DOWNLOAD NOW</button> -->
              <a href="<?php echo get_field('innovation_document', $informationList_id); ?>" class="theme-btn-primary"
          ...
          <div class="testimonials-box">
            ...
            <div class="testimonials-content common-conetnt">
              <p>
                ...
                echo mb_strimwidth(strip_tags($content), 0, 325, '...'); ?>
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            <div class="cover">
              ...
              <div class="thumb" id="thumb-content">
                <p class="common-conetnt">
                  <?php $content5 = get_post_field('post_content', $video_id);
                  echo mb_strimwidth(strip_tags($content5), 0, 300, '...');
                  ?>
                </p>
              </div>
            </div>
            ...
            <div class="resources-left">
              <div class="resources-content">
                <ul class="resources-top">
                  ...
                  <li><span><a href="http://">
                        <?php echo get_the_date('j \ M Y', $blog_id); ?>
                      </a></span></li>
                </ul>
                <div class="resources-bottom">
                  ...
                  <p>
                    <?php $content6 = get_post_field('post_content', $blog_id);
                    echo mb_strimwidth(strip_tags($content6), 0, 175, '...');
                    ?>
                  </p>
            ...
            <div class="resources-left">
              <div class="resources-content">
                <ul class="resources-top">
                  ...
                  <li><span><a href="http://">
                        <?php echo get_the_date('j \ M Y', $news_events_id); ?>
                ...
                <div class="resources-bottom">
                  ...
                  <p>
                    <?php $content7 = get_post_field('post_content', $news_events_id);
                    echo mb_strimwidth(strip_tags($content7), 0, 175, '...'); ?>
                  </p>
